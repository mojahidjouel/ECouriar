...
<div class="row">
<form class="row g-3 needs-validation" method="post" enctype="multipart/form-data" action="{{route('adminuser.store')}}" novalidate>
  @csrf
<div class="row">
  ...
  <div class="col-md-6 col-12 position-relative">
    <label for="contactNumber" class="form-label">Contact Number (English)<i class="text-danger">*</i></label>
