        ...
        <div class="container"><a class="navbar-brand" href=""><img src="{{asset('public/assets/img/gallery/logo1.jpg')}}" height="30" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" href="#aboutus">About Us</a></li>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <form class="row gx-2 gy-2 align-items-center" method="get" action="{{route('front.ordertrack')}}">
                <div class="col">
                  <div class="input-group-icon">
                    <label class="visually-hidden" for="inputEmailCta">Order number</label>
                    <input class="form-control input-box form-quriar-control text-light" name="orderid" type="text" placeholder="Order Number" />
                  </div>
                </div>
                <div class="d-grid gap-3 col-sm-auto">
                  <button class="btn btn-danger" type="submit">Track</button>
                </div>
              </form>
            </div>
          </div>
